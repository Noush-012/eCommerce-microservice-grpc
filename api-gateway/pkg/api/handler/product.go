...
import (
	...
	"github.com/Noush-012/project-ecommerce-microservice/api-gateway/pkg/utils"
...
type ProductHandler struct {
	ProductService client.ProductClient
}

func NewProductHandler(prodUseCase client.ProductClient) *ProductHandler {

...
import (
	...
	repo "github.com/Noush-012/project-ecommerce-microservice/user-service/pkg/repository/interface"
...
func (i *userDatabase) FindUser(ctx context.Context, user models.User) (models.User, error) {
...
func (i *userDatabase) GetUserbyID(ctx context.Context, userId uint) (models.User, error) {
...
func (i *userDatabase) GetWalletHistory(ctx context.Context, userId uint) (wallet []models.Wallet, err error) {
...
func (i *userDatabase) CreditUserWallet(ctx context.Context, data models.Wallet) error {

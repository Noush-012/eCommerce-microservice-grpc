...
import (
	...
	client "github.com/Noush-012/project-ecommerce-microservice/user-service/pkg/client/interface"
	"github.com/Noush-012/project-ecommerce-microservice/user-service/pkg/models"
	interfaces "github.com/Noush-012/project-ecommerce-microservice/user-service/pkg/repository/interface"
	service "github.com/Noush-012/project-ecommerce-microservice/user-service/pkg/usecase/interface"
...
type UserUseCase struct {
	...
	orderRepository client.OrderClient
}

func NewUserUseCase(repo interfaces.UserRepository, client client.OrderClient) service.UserService {
	return &UserUseCase{
		userRepository:  repo,
...
func (u *UserUseCase) GetWalletHistory(ctx context.Context, userId uint) (wallet []models.Wallet, err error) {

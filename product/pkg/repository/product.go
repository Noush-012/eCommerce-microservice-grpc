...
func (p *productDatabase) GetProduct(ctx context.Context, product models.Product) (models.Product, error) {
...
func (p *productDatabase) SaveProduct(ctx context.Context, product models.Product) error {
...
func (p *productDatabase) FindProduct(ctx context.Context, product models.Product) (models.Product, error) {
...
// find product by id
func (p *productDatabase) FindProductByID(ctx context.Context, productID uint) (product models.Product, err error) {
...
// update product
func (p *productDatabase) UpdateProduct(ctx context.Context, product models.Product) error {
...
func (p *productDatabase) DeleteProduct(ctx context.Context, productID uint) (models.Product, error) {
	...
	if err != nil {
		...
		return models.Product{}, errors.New("invalid product_id")
	}

	//delete query
	query := `DELETE FROM products WHERE id = $1`
	if err := p.DB.Exec(query, productID).Error; err != nil {
		return models.Product{}, fmt.Errorf("failed to delete error : %v", err)
	}
